<?php
	...
	require_once "modules/blocks/visuals/blocks/block_tab.php";
	require_once "modules/blocks/visuals/positions/position_tab.php";
	require_once "modules/blocks/block_pre_handler.php";
	require_once "modules/blocks/position_pre_handler.php";

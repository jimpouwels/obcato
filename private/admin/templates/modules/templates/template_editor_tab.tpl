<form id="template_editor_form" name="template_editor_form" method="post"
      action="{$backend_base_url}&template={$current_template_id}&scope={$scope}" enctype="multipart/form-data">

...
class ModuleDaoMysql implements ModuleDao {
    ...
    public function persistModule(Module $module): void {
        ...
        $statement->bind_param('ssiisiis', $titleTextResourceIdentifier, $iconUrl, $moduleGroupId, $popup, $identifier, $enabled, $systemDefault, $class);
        $this->mysqlConnector->executeStatement($statement);
    }
    ...
    public function updateModule(Module $module): void {
        ...
        $class = $module->getClass();
        $identifier = $module->getIdentifier();
        $statement->bind_param('ssiiss', $titleTextResourceIdentifier, $iconUrl, $moduleGroupId, $popup, $class, $identifier);
        $this->mysqlConnector->executeStatement($statement);
    }

...
class Smarty_Internal_Method_ConfigLoad
{
     ...
     *
     * @param \admin\view\smarty\sysplugins\Smarty_Internal_Data|\Smarty_Internal_Template|\Smarty $data
     * @param string $config_file filename
     * @param mixed                                                   $sections    array of section names, single
     *                                                                             section or null
     *
     * @return \Smarty|\admin\view\smarty\sysplugins\Smarty_Internal_Data|\Smarty_Internal_Template
     * @throws \Exception
     ...
     * load a config file, optionally load just selected sections
     *
     * @param \Smarty|\admin\view\smarty\sysplugins\Smarty_Internal_Data|\Smarty_Internal_Template $data
     * @param string $config_file filename
     * @param mixed                                                   $sections    array of section names, single
     *                                                                             section or null
    ...
    public function _loadConfigVars(Smarty_Internal_Template $tpl, $new_config_vars)
    {
        ...
        if ($tagScope >= 0) {
            ...
            if ($tpl->parent->_isTplObj() && ($tagScope || $tpl->parent->scope)) {
                ...
                if ($mergedScope) {
                    // update scopes
                    /* @var \Smarty_Internal_Template|\Smarty|\admin\view\smarty\sysplugins\Smarty_Internal_Data $ptr */

...
--
-- Host: 127.0.0.1    Database: pageflow
-- ------------------------------------------------------
...
LOCK
TABLES `article_overview_elements_metadata` WRITE;
...
LOCK
TABLES `article_target_pages` WRITE;
...
LOCK
TABLES `articles_element_terms` WRITE;
...
LOCK
TABLES `auth_users` WRITE;
/*!40000 ALTER TABLE `auth_users` DISABLE KEYS */;
INSERT INTO `auth_users`
VALUES (2, 'Developer', '5c08dfd8c8ade29ff8485a8cc0409cf6', 'jim.pouwels@gmail.com', 'Jim', 'Pouwels', '',
        '2011-10-30 12:42:05', '4ebbf2bdbc13e');
...
LOCK
TABLES `element_holders` WRITE;
/*!40000 ALTER TABLE `element_holders` DISABLE KEYS */;
INSERT INTO `element_holders`
VALUES (1, 2, 'Homepage', 1, 5, '2017-12-29 16:37:26', 2, 'ELEMENT_HOLDER_PAGE');
...
LOCK
TABLES `element_types` WRITE;
/*!40000 ALTER TABLE `element_types` DISABLE KEYS */;
INSERT INTO `element_types`
VALUES (1, 'TextElement', '/img/text_element.png', 'Paragraaf', 'text_element.php', 1, 'text_element', 1),
       (2, 'ListElement', '/img/list_element.png', 'Lijst', 'list_element.php', 2, 'list_element', 1),
       (3, 'ImageElement', '/img/image_element.png', 'Afbeelding', 'image_element.php', 3, 'image_element', 1),
       (4, 'DownloadElement', '/img/download_element.png', 'Download', 'download_element.php', 4, 'download_element',
        1),
       (5, 'ArticleOverviewElement', '/img/article_overview_element.png', 'Artikel overzicht',
        'article_overview_element.php', 7, 'article_overview_element', 1);
...
LOCK
TABLES `image_elements_metadata` WRITE;
...
LOCK
TABLES `list_element_items` WRITE;
...
LOCK
TABLES `list_elements_metadata` WRITE;
...
INSERT INTO `modules`
VALUES (1, 'logout_module_title', '/img/logout.png', 1, 0, 'logout', 1, 1, 'LogoutModuleVisual'),
       (2, 'settings_module_title', '/img/settings.png', 3, 0, 'settings', 1, 1, 'SettingsModuleVisual'),
       (3, 'pages_module_title', '/img/page.png', 2, 0, 'pages', 1, 1, 'PageModuleVisual'),
       (4, 'database_module_title', '/img/database.png', 3, 0, 'database', 1, 1, 'DatabaseModuleVisual'),
       (5, 'articles_module_title', '/img/articles.png', 2, 0, 'articles', 1, 1, 'ArticleModuleVisual'),
       (6, 'blocks_module_title', '/img/blocks.png', 2, 0, 'blocks', 1, 1, 'BlockModuleVisual'),
       (7, 'images_module_title', '/img/images.png', 2, 0, 'images', 1, 1, 'ImageModuleVisual'),
       (8, 'templates_module_title', '/img/templates.png', 4, 0, 'templates', 1, 1, 'TemplateModuleVisual'),
       (9, 'downloads_module_title', '/img/downloads.png', 2, 0, 'downloads', 1, 1, 'DownloadModuleVisual'),
       (11, 'authorization_module_title', '/img/authorization.png', 3, 0, 'authorization', 1, 1,
        'AuthorizationModuleVisual'),
       (12, 'components_module_title', '/img/components.png', 3, 0, 'components', 1, 1, 'ComponentsModuleVisual');
...
INSERT INTO `pages`
VALUES (1, 'Homepage', NULL, 1, 1, 1, 0, 1, 'Homepage');
...
LOCK
TABLES `templates` WRITE;
/*!40000 ALTER TABLE `templates` DISABLE KEYS */;
INSERT INTO `templates`
VALUES (1, '', 'Nieuw template', 1);
...
LOCK
TABLES `text_elements_metadata` WRITE;
